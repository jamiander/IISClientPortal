    ...
    <Modal
      ...
      <div className="space-y-5">
        ...
        <div className="h-10 w-full">
          <button id={EditThroughputIds.submitButton} className={submitButtonStyle} onClick={() => props.Submit(selectedCompany?.id ?? -1, GetInitiativeFromCompany(selectedCompany,selectedInitiativeIndex)?.id ?? -1,GetInitiativeFromCompany(selectedCompany,selectedInitiativeIndex)?.itemsCompletedOnDate ?? [])}>Submit</button>
