...
export function ClientActionsMenu(props: ClientActionsMenuProps)
{
  ...
  return (
    <ThemeProvider theme={IntegrityTheme}>
      ...
      <ArticleDataModal title={""} text={""} updatedDate={todayInfo} updatedBy={""} isIntegrityOnly={false} initiative={dummyInitiative} company={props.company} isOpen={articleModalIsOpen} isAdmin={props.isAdmin} setArticleModalIsOpen={setArticleModalIsOpen }></ArticleDataModal>
      <DocumentManagementModal isOpen={documentModalIsOpen} setIsOpen={setDocumentModalIsOpen} company={props.company} isAdmin={props.isAdmin} />
     </ThemeProvider>
  )
}
