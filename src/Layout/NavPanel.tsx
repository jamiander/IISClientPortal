      ...
      data-cy={NavPanelIds.menuButton}
        ...
        <Menu id="basic-menu"
          ...
          MenuListProps={{
            ...
            <button style={{ fontSize: '20px', marginTop: '30px', marginLeft: '10px', textAlign: "left" }} data-cy={NavPanelIds.initiatives} className={GetNavStyle("/Initiatives")}
            ...
            {currentUser?.isAdmin && currentUser?.isActive &&
              <button style={{ fontSize: '20px', marginTop: '30px', marginLeft: '10px', textAlign: "left" }} data-cy={NavPanelIds.users} className={GetNavStyle("/Users")}
            ...
            {currentUser?.isAdmin && currentUser?.isActive && currentUser?.companyId === IntegrityId &&
              <button style={{ fontSize: '20px', marginTop: '30px', marginLeft: '10px', textAlign: "left" }} data-cy={NavPanelIds.integrity} className={GetNavStyle("/Integrity")}
